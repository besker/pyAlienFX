...
class ServCmd:
    ...
    def __procCmd(s):
        try:
            cmd = s.__cli.recv(BUFSIZ).decode("utf-8")
        except KeyboardInterrupt:
            s.__cli.close()
            s.__serv.close()
            sys.exit(0)
                ...
                for c in cmd.split("|"):
                    ...
                    if command == "Set_Loop":
                        ...
                        if Save and Apply and block:
                            s.controller.Set_Color(
                                Area, Color, Save=Save, Apply=Apply, block=block
                            )
                        elif Save and Apply:
                            ...
                            s.controller.Set_Color(
                                Area, Color, Apply=Apply, block=block
                            )
                        elif Save:
                        ...
                        if arg[4]:
                            ...
                            block = None
                        if Save and Apply and block:
                            s.controller.Set_Color_Blink(
                                Area, Color, Save=Save, Apply=Apply, block=block
                            )
                        elif Save and Apply:
                            s.controller.Set_Color_Blink(
                                Area, Color, Save=Save, Apply=Apply
                            )
                        elif Save and block:
                            s.controller.Set_Color_Blink(
                                Area, Color, Save=Save, block=block
                            )
                        elif Apply and block:
                            s.controller.Set_Color_Blink(
                                Area, Color, Apply=Apply, block=block
                        ...
                        if Save and Apply and block:
                            ...
                            s.controller.Set_Color_Morph(
                                Area, Color1, Color2, Save=Save, Apply=Apply
                            )
                        elif Save and block:
                            s.controller.Set_Color_Morph(
                                Area, Color1, Color2, Save=Save, block=block
                            )
                        elif Apply and block:
                            s.controller.Set_Color_Morph(
                                Area, Color1, Color2, Apply=Apply, block=block
                            )
                        elif Save:
                            s.controller.Set_Color_Morph(
                                Area, Color1, Color2, Save=Save
                            )
                        elif Apply:
                            s.controller.Set_Color_Morph(
                                Area, Color1, Color2, Apply=Apply
                            )
                        elif block:
                            s.controller.Set_Color_Morph(
                                Area, Color1, Color2, block=block
                            )
