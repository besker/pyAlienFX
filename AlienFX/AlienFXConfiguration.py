# -*- coding: utf-8 -*-
#
# AlienFX Configuration
#
# Copyright (C) 2013  Ledjfou
#
...
from AlienFX.AlienFXComputers import *
    ...
    def Load(self, path):
        ...
        for line in lines:
            ...
            if split[0] == "name":
                ...
                area = split[1]
                self.area[split[1]] = configuration(
                    AllComputers.computerList[self.computer].computer.regions[area]
                )
            elif split[0] == "type":
