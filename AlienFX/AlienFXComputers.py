...
class M11XR3:
    def __init__(self):
        ...
        self.COMMAND_SAVE_NEXT = (
            0x08  # = Save next instruction in storage block (see storage)
        )
        ...
        self.suportedMode["standby"] = (
            AlienFXPowerMode(
                self.AlienFXProperties.STANDBY_ID,
                self.AlienFXTexts.STAND_BY_DESCRIPTION,
                self.BLOCK_STANDBY,
            ),
        )
        self.suportedMode["acPower"] = (
            AlienFXPowerMode(
                self.AlienFXProperties.AC_POWER_ID,
                self.AlienFXTexts.AC_POWER_DESCRIPTION,
                self.BLOCK_AC_POWER,
            ),
        )
        self.suportedMode["charging"] = (
            AlienFXPowerMode(
                self.AlienFXProperties.CHARGING_ID,
                self.AlienFXTexts.CHARGING2_DESCRIPTION,
                self.BLOCK_CHARGING,
            ),
        )
        self.suportedMode["onBat"] = AlienFXPowerMode(
            self.AlienFXProperties.ON_BATTERY_ID,
            self.AlienFXTexts.ON_BATTERY_DESCRIPTION,
        ...
        self.regions[self.AlienFXProperties.RIGHT_KEYBOARD_ID] = AlienFXRegion(
            ...
            self.AlienFXTexts.KEYBOARD_DESCRIPTION,
        ...
        self.regions[self.AlienFXProperties.MEDIA_BAR_ID] = AlienFXRegion(
            ...
            self.AlienFXTexts.MEDIA_BAR_DESCRIPTION,
...
class M14XLight:
    def __init__(self):
        ...
        self.regions[self.AlienFXProperties.RIGHT_KEYBOARD_ID] = AlienFXRegion(
            self.AlienFXProperties.RIGHT_KEYBOARD_ID,
            self.AlienFXTexts.RIGHT_KEYBOARD_DESCRIPTION,
            self.REGION_RIGHT_KEYBOARD,
            self.SUPPORTED_COMMANDS,
            True,
            True,
        ...
        self.regions[self.AlienFXProperties.RIGHT_CENTER_KEYBOARD_ID] = AlienFXRegion(
            self.AlienFXProperties.RIGHT_CENTER_KEYBOARD_ID,
            self.AlienFXTexts.RIGHT_CENTER_KEYBOARD_DESCRIPTION,
            self.REGION_MIDDLE_RIGHT_KEYBOARD,
            self.SUPPORTED_COMMANDS,
            True,
            True,
            True,
        ...
        self.regions[self.AlienFXProperties.LEFT_KEYBOARD_ID] = AlienFXRegion(
            self.AlienFXProperties.LEFT_KEYBOARD_ID,
            self.AlienFXTexts.LEFT_KEYBOARD_DESCRIPTION,
        ...
        self.regions[self.AlienFXProperties.LEFT_CENTER_KEYBOARD_ID] = AlienFXRegion(
            self.AlienFXProperties.LEFT_CENTER_KEYBOARD_ID,
            self.AlienFXTexts.LEFT_CENTER_KEYBOARD_DESCRIPTION,
            self.REGION_MIDDLE_LEFT_KEYBOARD,
            self.SUPPORTED_COMMANDS,
            True,
            True,
            True,
        ...
        self.regions[self.AlienFXProperties.ALIEN_HEAD_ID] = AlienFXRegion(
            self.AlienFXProperties.ALIEN_HEAD_ID,
            self.AlienFXTexts.ALIENWARE_HEAD_DESCRIPTION,
        ...
        self.regions[self.AlienFXProperties.TOUCH_PAD_ID] = AlienFXRegion(
            self.AlienFXProperties.TOUCH_PAD_ID,
            self.AlienFXTexts.TOUCHPAD_DESCRIPTION,
        ...
        self.regions[self.AlienFXProperties.POWER_BUTTON_EYES_ID] = AlienFXRegion(
            self.AlienFXProperties.POWER_BUTTON_EYES_ID,
            self.AlienFXTexts.ALIENWARE_POWERBUTTON_EYES_DESCRIPTION,
...
class M15XArea51:
    def __init__(self):
        ...
        self.regions[self.AlienFXProperties.LIGHT_PIPE_ID] = AlienFXRegion(
            self.AlienFXProperties.LIGHT_PIPE_ID,
            self.AlienFXTexts.LIGHT_PIPE_DESCRIPTION,
        ...
        self.regions[self.AlienFXProperties.KEYBOARD_ID] = AlienFXRegion(
            self.AlienFXProperties.KEYBOARD_ID,
            self.AlienFXTexts.KEYBOARD_DESCRIPTION,
...
class AllComputers:
    ...
    computerList = {
        ...
        "M15XAllPowerful": AlienFXComputer(
            "M15XAllPowerful", 0x187C, 0x0512, M15XAllPowerfull()
        ),
